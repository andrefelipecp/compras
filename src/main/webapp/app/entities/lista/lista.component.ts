...
export class ListaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.listaService
      ...
      .subscribe(
        (res: HttpResponse<ILista[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInListas(): void {
    this.eventSubscriber = this.eventManager.subscribe('listaListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ILista[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
